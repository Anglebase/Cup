...
set(INCLUDE_DIRS ${M_INCLUDE_DIRS} ${MODE_INCLUDE_DIRS} ${GEN_INCLUDE_DIRS} ${GEN_MODE_INCLUDE_DIRS} ${INC} ${FEAT_INCLUDE_DIRS})
set(LIB_DIRS ${M_LIB_DIRS} ${MODE_LIB_DIRS} ${GEN_LIB_DIRS} ${GEN_MODE_LIB_DIRS} ${FEAT_LIB_DIRS})
set(LIBS ${M_LIBS} ${MODE_LIBS} ${GEN_LIBS} ${GEN_MODE_LIBS} ${DEPS} ${FEAT_LIBS})
set(DEFINES ${M_DEFINES} ${MODE_DEFINES} ${GEN_DEFINES} ${GEN_MODE_DEFINES} ${FEAT_DEFINES})
set(COPTIONS ${M_COPTIONS} ${MODE_COPTIONS} ${GEN_COPTIONS} ${GEN_MODE_COPTIONS} ${FEAT_COPTIONS})
set(LINKOPTIONS ${M_LINKOPTIONS} ${MODE_LINKOPTIONS} ${GEN_LINKOPTIONS} ${GEN_MODE_LINKOPTIONS} ${FEAT_LINKOPTIONS})

add_library(${EXPORT_NAME} INTERFACE)
target_include_directories(${EXPORT_NAME} INTERFACE ${INCLUDE_DIRS})
target_link_directories(${EXPORT_NAME} INTERFACE ${LIB_DIRS})
target_link_libraries(${EXPORT_NAME} INTERFACE ${LIBS})
