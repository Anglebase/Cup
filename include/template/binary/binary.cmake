...
target_link_libraries(${UNIQUE_NAME} PRIVATE ${LIBRARIES})
...
foreach(BIN_MAIN_FILE ${BIN_MAIN_FILES})
    ...
    target_link_libraries(${UNIQUE_BIN_NAME} PRIVATE ${LIBRARIES})
...
foreach(TEST_MAIN_FILE ${TEST_MAIN_FILES})
    ...
    target_link_libraries(${UNIQUE_TEST_NAME} PRIVATE ${LIBRARIES})
