...
set(TEST_LINK_DIRS ${%TEST_LINK_DIRS%})
set(TEST_LINK_LIBS ${%TEST_LINK_LIBS%})
set(TEST_LOPTIONS ${%TEST_LOPTIONS%})
...
foreach(TEST_MAIN_FILE ${TEST_MAIN_FILES})
    ...
    target_include_directories(${UNIQUE_TEST_NAME} PRIVATE ${INCLUDE_DIRS} ${TEST_INC})
    target_link_directories(${UNIQUE_TEST_NAME} PRIVATE ${LIBRARY_DIRS} ${TEST_LINK_DIRS})
    target_link_libraries(${UNIQUE_TEST_NAME} PRIVATE ${LIBRARIES} ${DEPENDS} ${TEST_LINK_LIBS})
    target_compile_definitions(${UNIQUE_TEST_NAME} PRIVATE ${DEFINES} ${TEST_DEFINES})
    target_compile_options(${UNIQUE_TEST_NAME} PRIVATE ${COPTIONS} ${TEST_COPTIONS})
    target_link_options(${UNIQUE_TEST_NAME} PRIVATE ${LOPTIONS} ${TEST_LOPTIONS})
...
unset(TEST_LINK_DIRS)
unset(TEST_LINK_LIBS)
unset(TEST_LOPTIONS)
unset(TEST_COPTIONS)
#)"